  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '8px' }}>
        <a href="https://alxnrocha.github.io/booking-app/" target="_blank" rel="noopener noreferrer" style={{ color: '#58a6ff', textDecoration: 'underline', fontSize: '12px', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace', wordBreak: 'break-all', display: 'block' }}>
